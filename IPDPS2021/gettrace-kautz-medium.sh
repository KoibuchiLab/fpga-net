...
cd multitree-kautz
make
topo=( 4 8 16 ) #9 10 11 12 13 16 32 64)
numitems=( 1048576 2097152  4194304 8388608 16777216 33554432 67108864 134217728 268435456 )
...
do
    ...
    do
        ...
        $exe -np $nproc $defaultconfig -hostfile $hostfile -platform $platform -trace-file $tracefile ./allreducesmpi-b --num-item $numitem --algorithm $algo
