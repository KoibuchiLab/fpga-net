...
../../simgrid-3.28/install/bin/smpirun -np 72 --cfg=smpi/shared-malloc:global --cfg=smpi/shared-malloc-blocksize:137438953472 --cfg=smpi/host-speed:1Gf -hostfile ../hostfiles/kautz/kautz8-2.txt \
