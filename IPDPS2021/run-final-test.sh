...
../../simgrid-3.28/install/bin/smpirun -np 72 --cfg=smpi/shared-malloc:global --cfg=smpi/shared-malloc-blocksize:144245094400 --cfg=smpi/host-speed:1Gf -hostfile ../hostfiles/kautz/kautz8-2.txt \
...
../simgrid-3.28/install/bin/smpirun --cfg=smpi/shared-malloc:global --cfg=smpi/shared-malloc-blocksize:144245094400 --cfg=smpi/host-speed:1Gf -np 272 -hostfile ./hostfiles/2lvfc/16x17.txt \
