...
make resnet-cmb
../../simgrid-3.28/install/bin/smpirun -np 272 -map -hostfile ../hostfiles/kautz/kautz16-2.txt -platform ../platforms/kautz/kautz16-2.xml  --cfg=smpi/host-speed:100000000000f --cfg=smpi/display-timing:1 --log=smpi_coll.:critical ./RESNET50-cmb.run 1280000 32 1 2>&1 ../results/benchmark/resnet-cmb
