...
teshsuite/simdag/CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.o: teshsuite/simdag/comp-only-seq/comp-only-seq.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/kienpham/project/fpga_network/SimGrid-3.21/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object teshsuite/simdag/CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.o"
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.o   -c /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-seq/comp-only-seq.c
...
teshsuite/simdag/CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.i: cmake_force
	...
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-seq/comp-only-seq.c > CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.i
...
teshsuite/simdag/CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.s: cmake_force
	...
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-seq/comp-only-seq.c -o CMakeFiles/comp-only-seq.dir/comp-only-seq/comp-only-seq.c.s
...
teshsuite/simdag/comp-only-seq/comp-only-seq: teshsuite/simdag/CMakeFiles/comp-only-seq.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/kienpham/project/fpga_network/SimGrid-3.21/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable comp-only-seq/comp-only-seq"
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/comp-only-seq.dir/link.txt --verbose=$(VERBOSE)
...
teshsuite/simdag/CMakeFiles/comp-only-seq.dir/clean:
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && $(CMAKE_COMMAND) -P CMakeFiles/comp-only-seq.dir/cmake_clean.cmake
