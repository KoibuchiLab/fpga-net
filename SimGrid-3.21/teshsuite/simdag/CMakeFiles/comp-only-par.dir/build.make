...
teshsuite/simdag/CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.o: teshsuite/simdag/comp-only-par/comp-only-par.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/kienpham/project/fpga_network/SimGrid-3.21/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object teshsuite/simdag/CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.o"
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.o   -c /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-par/comp-only-par.c
...
teshsuite/simdag/CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.i: cmake_force
	...
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-par/comp-only-par.c > CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.i
...
teshsuite/simdag/CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.s: cmake_force
	...
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag/comp-only-par/comp-only-par.c -o CMakeFiles/comp-only-par.dir/comp-only-par/comp-only-par.c.s
...
teshsuite/simdag/comp-only-par/comp-only-par: teshsuite/simdag/CMakeFiles/comp-only-par.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/kienpham/project/fpga_network/SimGrid-3.21/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable comp-only-par/comp-only-par"
	cd /home/kienpham/project/fpga_network/SimGrid-3.21/teshsuite/simdag && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/comp-only-par.dir/link.txt --verbose=$(VERBOSE)
