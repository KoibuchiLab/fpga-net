...
void sg_platf_new_cluster(simgrid::kernel::routing::ClusterCreationArgs* cluster)
{
  ...
  using simgrid::kernel::routing::ClusterOptElecSimpleZone;
  int rankId=0;
  ...
  switch (cluster->topology) {
    ...
    case simgrid::kernel::routing::ClusterTopology::DRAGONFLY:
      ...
      break;
    case simgrid::kernel::routing::ClusterTopology::OPT_ELEC_SIMPLE:
      zone.routing = A_surfxml_AS_routing_ClusterOptElecSimple;
      break;
...
simgrid::kernel::routing::NetZoneImpl* sg_platf_new_Zone_begin(simgrid::kernel::routing::ZoneCreationArgs* zone)
{
  ...
  switch (zone->routing) {
    ...
    case A_surfxml_AS_routing_ClusterDragonfly:
      ...
      break;
    case A_surfxml_AS_routing_ClusterOptElecSimple:
      new_zone = new simgrid::kernel::routing::ClusterOptElecSimpleZone(current_routing, zone->id, netmodel);
      break;
