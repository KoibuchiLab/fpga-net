...
typedef enum { AU_surfxml_cluster_topology, A_surfxml_cluster_topology_FLAT,A_surfxml_cluster_topology_TORUS,A_surfxml_cluster_topology_FAT___TREE,A_surfxml_cluster_topology_DRAGONFLY,A_surfxml_cluster_topology_OPT___ELEC___SIMPLE,A_surfxml_cluster_topology_OPT___ELEC___FAT___TREE } AT_surfxml_cluster_topology;
