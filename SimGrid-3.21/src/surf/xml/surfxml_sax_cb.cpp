...
void ETag_surfxml_cluster(){
  ...
  case A_surfxml_cluster_topology_DRAGONFLY:
    ...
    break;
  case A_surfxml_cluster_topology_OPT___ELEC___SIMPLE:
    cluster.topology = simgrid::kernel::routing::ClusterTopology::OPT_ELEC_SIMPLE;
    break;
  case A_surfxml_cluster_topology_OPT___ELEC___FAT___TREE:
    cluster.topology = simgrid::kernel::routing::ClusterTopology::OPT_ELEC_FAT_TREE;
    break;
  default:
