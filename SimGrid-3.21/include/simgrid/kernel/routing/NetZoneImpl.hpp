...
protected:
  ...
  virtual void get_local_route(NetPoint* src, NetPoint* dst, double size, RouteCreationArgs* into, double* latency) = 0;
  /** @brief retrieves the list of all routes of size 1 (of type src x dst x Link) */
  /* returns whether we found a bypass path */
  bool get_bypass_route(routing::NetPoint* src, routing::NetPoint* dst,
                        /* OUT */ std::vector<resource::LinkImpl*>& links, double* latency);
  bool get_bypass_route(routing::NetPoint* src, routing::NetPoint* dst,double size,
                        /* OUT */ std::vector<resource::LinkImpl*>& links, double* latency);
...
public:
  ...
  static void get_global_route(routing::NetPoint* src, routing::NetPoint* dst,
                               /* OUT */ std::vector<resource::LinkImpl*>& links, double* latency);
  static void get_global_route(routing::NetPoint* src,routing::NetPoint* dst,double size, 
                               /* OUT */ std::vector<resource::LinkImpl*>& links, double* latency);
